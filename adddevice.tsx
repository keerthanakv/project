...
export const AdddeviceScreen: FC<StackScreenProps<NavigatorParamList, "adddevice">> = observer(
  ({ navigation }) => {
    let nextScreen = () => navigation.replace("selectdevice")
    ...
    return (
      <View testID="AddgatewayScreen" style={FULL}>
        ...
        <View style={styles.view}>
          <Text style={styles.main}>Please be <Text style={styles.inner}>Five Feet</Text> closer to the</Text><Text style={styles.inner1}>Device.</Text>
        </View>
        <View style={styles.view}>
          <LottieView

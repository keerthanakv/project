...
export const ConnectwifiScreen: FC<StackScreenProps<NavigatorParamList, "connectwifi">> = observer(
  ({ navigation, route }) => {
    let nextScreen = () => navigation.replace("configurec")
    ...
    return (
      <View testID="SelectgatewayScreen" style={FULL}>
        ...
        <Header
          ...
          onLeftPress={goBack}
        />
        <Text style={styles.text}>Connect to Wi-Fi</Text>
        ...
        <Button activeOpacity={0.2}onPress={() =>nextScreen()} style={styles.btn}>
          <Text style={styles.btntxt}>Connect & Complete Set up</Text>
        </Button>
